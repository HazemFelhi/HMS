<div class="row gx-10 mb-5">
    <div class="col-lg-3 col-md-4 col-sm-12 mb-5">
        ...
        {{ Form::text('sr_no', $srNo, ['class' => 'form-control form-control-solid', 'required', 'tabindex' => '1']) }}
    </div>
    <div class="col-lg-3 col-md-4 col-sm-12 mb-5">
        ...
        {{ Form::text('payroll_id', $payrollId, ['class' => 'form-control form-control-solid', 'required', 'tabindex' => '2','readonly']) }}
    </div>
    <div class="col-lg-3 col-md-4 col-sm-12 mb-5 myclass">
        ...
        {{ Form::select('type', $types, null, ['id' => 'type','class' => 'form-select form-select-solid fw-bold', 'required','placeholder' => 'Select Role','data-control' => 'select2']) }}
    </div>
    <div class="col-lg-3 col-md-4 col-sm-12 mb-5">
        {{ Form::label('owner_id',__('messages.employee_payroll.employee').':', ['class' => 'form-label required fs-6 fw-bolder text-gray-700 mb-3']) }}
        {{ Form::select('owner_id', [], null, ['id' => 'ownerType','class' => 'form-select form-select-solid fw-bold','required','disabled','data-control' => 'select2', 'placeholder' => 'Select Employee']) }}
    </div>
    <div class="col-lg-3 col-md-4 col-sm-12 mb-5">
        {{ Form::label('month',__('messages.employee_payroll.month').':', ['class' => 'form-label required fs-6 fw-bolder text-gray-700 mb-3']) }}
        {{ Form::selectMonth('month',null, ['id' => 'month','class' => 'form-select form-select-solid fw-bold','required','data-control' => 'select2']) }}
    </div>
    <div class="col-lg-3 col-md-4 col-sm-12 mb-5">
    ...
    <div class="col-lg-3 col-md-4 col-sm-12 mb-5">
        ...
        {{ Form::text('net_salary', 0, ['id' => 'netSalary','class' => 'form-control price-input form-control-solid','onkeyup' => 'if (/\D\./g.test(this.value)) this.value = this.value.replace(/\D\./g,"")', 'maxlength' => '7','required','readonly']) }}
    </div>
</div>
