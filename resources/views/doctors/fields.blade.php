...
<div class="row">
    ...
    <div class="form-group col-sm-6  mb-5">
        ...
        {{ Form::select('doctor_department_id', $doctorsDepartments, null, ['class' => 'form-select form-select-solid', 'id' => 'doctorDepartmentId', 'placeholder' => 'Select Department', 'data-control' => 'select2','required']) }}
    </div>
    <div class="col-md-6">
        <div class="form-group mb-5">
    ...
    <div class="col-md-3">
        <div class="form-group mb-5">
            ...
            {{ Form::password('password', ['class' => 'form-control form-control-solid','required','min' => '6','max' => '10']) }}
        </div>
    </div>
    <div class="col-md-3">
        <div class="form-group mb-5">
            ...
            {{ Form::password('password_confirmation', ['class' => 'form-control form-control-solid','required','min' => '6','max' => '10']) }}
        </div>
    </div>
        ...
        <div class="row2">
            <label class="fs-5 fw-bold mb-2 d-block" for="image"> <span>{{__('messages.profile.profile')}}: </span>
                <i class="fa fa-question-circle ms-1 fs-7" data-bs-toggle="tooltip"
                   title="Best resolution for this profile will be 325x375"></i>
            </label>
