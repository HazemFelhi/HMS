...
<div id="kt_aside" class="aside aside-dark aside-hoverable sidebar-font-size" data-kt-drawer="true"
    ...
    <div class="aside-logo flex-column-auto h-75px" id="kt_aside_logo">
        <!--begin::Logo-->
        <a href="#" data-toggle="tooltip" data-placement="right" class="d-flex align-items-center"
           title="{{ getAppName() }}">
            <img class="navbar-brand-minimized h-60px  logo me-5" src="{{ getSettingValue('app_logo') }}" alt="Logo"/>
