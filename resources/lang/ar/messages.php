...
return [
    ...
    */
    ...
    'bed_types'               => 'أنواع الغرفه',
    'beds'                    => 'غرفه',
    'bed_assigns'             => 'تعيينات الغرفه',
    'packages'                => 'الحزم',
    'schedules'               => 'جداول',
    'schedule_label'          => 'جدول',
    'services'                => 'خدمات',
    ...
    'bed'                     => [
        'bed'           => 'غرفه جديد',
        'beds'          => 'غرفه',
        'bed_details'   => 'تفاصيل الغرفه',
        'new_bed'       => 'غرفه جديد',
        'edit_bed'      => 'تحرير الغرفه',
        'new_bulk_bed'  => 'غرفه ضخم جديد',
        'name'          => 'اسم',
        'bed_type'      => 'نوع الغرفه',
        'charge'        => 'الشحنة',
        'available'     => 'متاح',
    ...
    'bed_type'                => [
        'bed_type'         => 'نوع الغرفه',
        'bed_types'        => 'أنواع الغرفه',
        'bed_type_details' => 'تفاصيل نوع الغرفه',
        'new_bed_type'     => 'نوع غرفه جديد',
        'edit_bed_type'    => 'تحرير نوع الغرفه',
        'title'            => 'عنوان',
        'description'      => 'وصف',
    ],
    ...
    // bed assigns keys
    'bed_assign'  => [
        'bed_assign'         => 'تعيين الغرفه',
        'bed_assigns'        => 'تعيينات الغرفه',
        'bed_assign_details' => 'تفاصيل تعيين الغرفه',
        'new_bed_assign'     => 'تعيين غرفه جديد',
        'edit_bed_assign'    => 'تحرير تعيين الغرفه',
        'patient_name'       => 'اسم المريض',
        'bed_name'           => 'اسم الغرفه',
        'case_id'            => 'ID القضية',
